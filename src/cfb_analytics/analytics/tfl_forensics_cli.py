...
from cfb_analytics.analytics.tfl_forensics import tfl_forensics,concise_tfl_forensics
...
def main():
 ...
 r=tfl_forensics(plays);print(json.dumps(r,indent=2) if a.as_json else concise_tfl_forensics(r))
