...
from cfb_analytics.analytics.kneel_sequence_forensics import kneel_sequence_forensics,concise
...
def main():
 ...
 r=kneel_sequence_forensics(plays);print(json.dumps(r,indent=2) if a.as_json else concise(r))
