...
from cfb_analytics.analytics.down_situation_forensics import audit_down_situations,concise
...
def main():
 ...
 r=audit_down_situations(plays);print(json.dumps(r,indent=2,sort_keys=True) if a.as_json else concise(r))
