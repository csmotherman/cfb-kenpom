...
from cfb_analytics.analytics.kneel_confidence_audit import kneel_confidence_audit,concise
...
def main():
 ...
 r=kneel_confidence_audit(plays);print(json.dumps(r,indent=2) if a.as_json else concise(r))
