...
from cfb_analytics.analytics.goal_line_zero_sequence_forensics import audit,concise
...
def main():
 ...
 r=audit(plays);print(json.dumps(r,indent=2,sort_keys=True) if a.as_json else concise(r))
