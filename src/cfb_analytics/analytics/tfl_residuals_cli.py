...
from cfb_analytics.analytics.tfl_residuals import residual_audit,concise
...
def main():
 ...
 r=residual_audit(plays);print(json.dumps(r,indent=2) if a.as_json else concise(r))
