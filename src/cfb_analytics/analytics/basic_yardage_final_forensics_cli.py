...
from cfb_analytics.analytics.basic_yardage_final_forensics import audit,merge,concise
SEASONS=(2014,2015,2016,2017,2018,2019,2021,2022,2023,2024,2025)
def main():
 p=argparse.ArgumentParser();p.add_argument('command',choices=('audit',));p.add_argument('--root',type=Path,default=Path('data/raw'));p.add_argument('--processed-root',type=Path,default=Path('data/processed'));p.add_argument('--season',type=int);a=p.parse_args();rs=[]
