...
from cfb_analytics.analytics.late_down_conversion_forensics import audit_late_down_conversions,concise
...
def main():
 ...
 r=audit_late_down_conversions(plays);print(json.dumps(r,indent=2,sort_keys=True) if a.as_json else concise(r))
