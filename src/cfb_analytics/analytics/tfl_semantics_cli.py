...
from cfb_analytics.analytics.tfl_semantics import tfl_semantic_audit,concise
...
def main():
 ...
 r=tfl_semantic_audit(plays);print(json.dumps(r,indent=2) if a.as_json else concise(r))
