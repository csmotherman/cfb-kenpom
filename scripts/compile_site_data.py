...
def main():
    ...
    js = (
        ...
        "// adjO/adjD/adjEM are AdjOff/AdjDef/AdjNet. The hierarchical_hfa route\n"
        "// now publishes PRIME v6: field-position-adjusted possession APR plus\n"
        "// opponent-adjusted Success Rate and Explosiveness using frozen 2014-2025\n"
        "// walk-forward-validated weights. EPA was tested and excluded as redundant.\n"
        "// Play-level components exclude garbage time; AdjNet = AdjOff + AdjDef.\n"
        "// Under the legacy rollback model adjEM is the\n"
