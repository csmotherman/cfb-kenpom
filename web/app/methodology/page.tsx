    ...
    <>
      ...
      <main id="methodologyContent" className="container methodology-main">
        ...
        <section className="methodology-section">
          ...
          <p>
            APR stands for Adjusted Possession Rating. Possession efficiency remains the backbone, but PRIME v6 now combines three opponent-adjusted components: field-position-adjusted scoring value per resolved possession, Success Rate, and Explosiveness. The live blend was selected from a leakage-safe 2014&ndash;2025 walk-forward test; EPA was also tested but did not add meaningful incremental signal once Success Rate and Explosiveness were included. Net APR is the overall team-strength metric, while Off APR and Def APR are its offensive and defensive sides. A team&rsquo;s own rating is never blended with a preseason rating, recruiting input or conference-strength term. During the first three site weeks only, the possession component&rsquo;s opponent-strength adjustment is stabilized with a tapered prior-season opponent baseline; that influence is 50% through Week 2, 25% in Week 3 and 0% from Week 4 onward.
          </p>
          <div className="methodology-definitions">
            <Definition term="APR" tag="System" text="Adjusted Possession Rating: PRIME’s opponent-adjusted performance system. Possession efficiency is the backbone, with validated Success Rate and Explosiveness components added in PRIME v6." />
            <Definition term="Net APR" tag="Overall" text="The overall team-strength rating. Net APR = Off APR + Def APR. Zero is approximately FBS average; higher is better." />
            <Definition term="Off APR" tag="Core" text="Offensive composite of field-position-adjusted possession APR, opponent-adjusted Success Rate and opponent-adjusted Explosiveness. Higher is better." />
            <Definition term="Def APR" tag="Core" text="Defensive composite of possession scoring prevention, opponent-adjusted Success Rate prevention and opponent-adjusted Explosiveness prevention. Higher is better." />
        ...
        <section className="methodology-section" id="metric-versions">
          ...
          <div className="methodology-rules">
            ...
            <p><strong>APR (Net, Off, Def).</strong> 2014&ndash;2025 historical files remain on their original possession-efficiency versions. 2026 uses PRIME v6: field-position-adjusted possession APR plus opponent-adjusted Success Rate and Explosiveness. Cross-era comparisons should therefore be treated as approximate until history is rebuilt on the v6 definition.</p>
