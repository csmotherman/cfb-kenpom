...
const PRESETS = [
  ...
  },
  {
    ...
    y: "ratings.adjO",
    title: "Offensive Rating vs Adjusted Success Rate",
    xReverse: false,
    yReverse: false,
    quadrants: ["Big Plays Carrying", "Complete Offenses", "Limited Offenses", "Efficient, Low Ceiling"],
  },
  {
    name: "Defense vs Success Allowed",
    x: "advanced.successAdjAllowed",
    y: "ratings.adjD",
    title: "Defensive Rating vs Success Rate Allowed",
    xReverse: true,
    yReverse: false,
    quadrants: ["Disruptive, Leaky", "Complete Defenses", "Defensive Issues", "Bend, Don't Break"],
  },
  {
    name: "Pass EPA vs Rush EPA",
