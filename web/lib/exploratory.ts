...
export const SERIES_OFFENSE: ExpColumn[] = [
  {
    ...
    profileNote: "A series is one fresh set of downs. Did the offense earn another first down or TD before it ended?",
  ...
  },
  {
    ...
    profileNote: "After a failed 1st- or 2nd-down play, how often does the offense still recover for a first down or TD?",
  ...
  },
  {
    ...
    profileNote: "How often a series stays out of 3rd-and-7 or longer.",
...
const SERIES_DEFENSE: ExpColumn[] = [
  {
    ...
    profileNote: "How often the defense ends a fresh opponent series before another first down or TD.",
  ...
  },
  {
    ...
    profileNote: "After winning 1st or 2nd down, how often does the defense finish the series before the offense recovers?",
  ...
  },
  {
    ...
    profileNote: "How often the defense gets an opponent series to 3rd-and-7 or longer.",
...
const POSSESSIONS_OFFENSE: ExpColumn[] = [
  {
    ...
    profileNote: "A clean drive has no turnover, sack, TFL, costly accepted offensive penalty, or failed 4th down.",
  ...
  },
  {
    ...
    profileNote: "A mistake-drive has a turnover, sack, TFL, costly accepted penalty, or failed 4th. It is killed if the offense never recovers for another first down or TD.",
...
const POSSESSIONS_DEFENSE: ExpColumn[] = [
  {
    ...
    profileNote: "How often opponents complete a drive without a turnover, sack, TFL, costly penalty, or failed 4th down.",
  ...
  },
  {
    ...
    profileNote: "Once an opponent has a mistake-drive, how often does the defense keep it dead? This measures finishing the drive, not creating the mistake.",
...
const STYLE_RISK: ExpColumn[] = [
  {
    ...
    profileNote: "How much of the offense's positive EPA comes from big plays: rushes of 10+ yards or passes of 20+ yards. Style, not quality.",
  ...
  },
  {
    ...
    profileNote: "How efficient the offense is after removing explosive plays from the sample.",
  ...
  },
  {
    ...
    profileNote: "How often an offensive play has negative EPA and reduces expected scoring value.",
  ...
  },
  {
    ...
    profileNote: "When the offense has a negative-EPA play, how much EPA does that bad play cost on average?",
  ...
  },
  {
    ...
    profileNote: "The offense's total negative-play damage spread across every eligible play. It combines frequency and severity.",
  ...
  },
  {
    ...
    profileNote: "The defensive version of Failure Burden: how much negative-play EPA damage opponents absorb per eligible play.",
