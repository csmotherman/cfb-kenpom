...
const GAME_SHAPE: [string, Spec[]][] = [
  ...
  ["Explosiveness", [
    { label: "Explosive Play Rate", key: "explosive_play_rate", fmt: pct, tip: "Share of eligible offensive plays that are both successful (Success Rate's own down/distance standard) AND gain 15+ yards through the air or 10+ on the ground. Higher is better. PRIME-derived -- this is a frequency, a different concept from CFBD's own \"explosiveness\" below (an average magnitude), so it is not replaced by it." },
